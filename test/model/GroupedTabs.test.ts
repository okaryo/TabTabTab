...
describe('#id', () => {
  it('should return group id', () => {
    const actual = new GroupedTabs(new GroupId(1), 'name', new GroupedColor('red'), []).id
...
describe('#name', () => {
  it('should return group name', () => {
    const actual = new GroupedTabs(new GroupId(1), 'name', new GroupedColor('red'), []).name
    const expected = 'name'
...
describe('#colorCode', () => {
  it('should return group color code', () => {
    const actual = new GroupedTabs(new GroupId(1), 'name', new GroupedColor('red'), []).colorCode
...
describe('#length', () => {
  describe('when tabs count is 0', () => {
    it('should return 0', () => {
      const actual = new GroupedTabs(new GroupId(1), 'name', new GroupedColor('red'), []).length
      const expected = 0
      expect(actual).toBe(expected)
    })
  })
...
describe('#isEmpty', () => {
  describe('when tabs count is 0', () => {
    it('should return true', () => {
      const actual = new GroupedTabs(new GroupId(1), 'name', new GroupedColor('red'), []).isEmpty
